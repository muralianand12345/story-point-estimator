...
const RoomCreation: React.FC = () => {
    ...
    return (
        <div className="max-w-md mx-auto p-8 bg-card rounded-xl shadow-md">
            <h2 className="text-2xl font-bold text-foreground mb-6 text-center">Create a New Room</h2>

            {error && (
                <div className="mb-6 p-4 bg-destructive/10 border-l-4 border-destructive text-destructive-foreground rounded-md">
                    <div className="flex">
